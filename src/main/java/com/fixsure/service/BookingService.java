...
public class BookingService {
    ...
    public BookingDto.Response createBooking(BookingDto.CreateRequest req) {
        ...
        Payment payment = Payment.builder()
                ...
                .status(req.getPaymentMethod() == PaymentMethod.CASH ? PaymentStatus.PENDING : PaymentStatus.PENDING)
                .amount(totalAmount)
                .build();
    ...
    public BookingDto.Response toResponse(Booking booking) {
        ...
        return BookingDto.Response.builder()
                ...
                .technicianPhone(booking.getTechnician() != null ? booking.getTechnician().getPhone() : null)
                .payment(paymentDto)
